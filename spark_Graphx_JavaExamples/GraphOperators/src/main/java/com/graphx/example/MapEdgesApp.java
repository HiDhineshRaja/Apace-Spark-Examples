...
public class MapEdgesApp {
	private static Logger log = Logger.getLogger(MapEdgesApp.class);
	...
	public void inDegree() {
		...
		//creating new Edge from old edge
		//  But In this example I didn't create.
		Graph<String[], String> g = graph.mapEdges(new MapEdgeFuntion(),
	...
	public static void main(String[] args) {
		MapEdgesApp app = new MapEdgesApp();
		app.inDegree();
	}
}

class MapEdgeFuntion extends AbstractFunction1<Edge<String>, String> implements
		Serializable {

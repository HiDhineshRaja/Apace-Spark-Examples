...
public class MapTripletsApp {
	private static Logger log = Logger.getLogger(MapTripletsApp.class);
	...
	public void inDegree() {
		...
		Graph<String[], EdgeTriplet<String[], String>> result =  
				graph.mapTriplets(new MapTripletsFuntion(), 
						ClassTag$.MODULE$.apply(EdgeTriplet.class));

		log.debug(result.edges().count());
		

	}

	public static void main(String[] args) {
		MapTripletsApp app = new MapTripletsApp();
		app.inDegree();
	}
}

class MapTripletsFuntion extends AbstractFunction1<EdgeTriplet< String[], String>, EdgeTriplet<String[], String>>
		implements Serializable {
	@Override
	public EdgeTriplet<String[], String> apply(EdgeTriplet<String[], String> arg) {
		return arg;
	}
}
